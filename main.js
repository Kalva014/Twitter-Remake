...
// Refresh tweets every 5 seconds if the user checked the check box
function refreshTweets() {
    console.log('Before sorting by date and removing duplicates')
    console.log(tweets)

    while (tweetContainer.firstChild) { // NOT SURE WHAT THIS DOES LOL
    ...
    console.log('After sorting by date and removing duplicates')
    console.log(tweets)
...
// Listens to see if check box is checked then refresh
checkBox.addEventListener('change', (event) => {
    if (event.currentTarget.checked == true) {
        timer = setInterval(getTweets, (5000)); // THIS MIGHT GIVE A MAJOR ERROR
        console.log("Check box is checked so refresh tweets every 5 seconds");
    }
    else {
